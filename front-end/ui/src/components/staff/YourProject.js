              ...
              <div className="pt-5 px-5">
                ...
                >
                  <tr style={{ borderBottom: "1px solid #bdbdbd" }}>
                    ...
                    <td>
                      <b className="text-muted">{project.ProjectID}</b>
                    </td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid #bdbdbd" }}>
                    <td className="text-start">
                    ...
                    <td>
                      <b className="text-muted">{project.Manager}</b>
                    </td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid #bdbdbd" }}>
                    <td className="text-start">
                    ...
                    <td>
                      <b className="text-muted">{project.Staffs?.length}</b>
                    </td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid #bdbdbd" }}>
                    <td className="text-start">
                    ...
                    <td>
                      <b className="text-muted">
                        {" "}
                        {moment(project.TimeStart).format("MM-DD-YYYY")}{" "}
                      </b>
                    </td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid #bdbdbd" }}>
                    ...
                    <td>
                      <b className="text-muted">
                        {moment(project.TimeEnd).format("MM-DD-YYYY")}
                      </b>
                    </td>
                  </tr>
                </table>
